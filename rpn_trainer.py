...
train_data = train_data.map(lambda x : data_utils.preprocessing(x, img_width, img_height, apply_augmentation=True))
val_data = val_data.map(lambda x : data_utils.preprocessing(x, img_width, img_height))
